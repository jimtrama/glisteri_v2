  ...
  categories: [
    ...
    //Ximoi
    {
      ...
      products: [
        ...
        {
          title: { el: "Smoothie Fraoulita", en: "Smoothie Fraoulita" },
          desc: { el: "Φράουλα, Μπανάνα, Μήλο, Cranberry", en: "Strawberry, Banana, Apple, Cranberry" },
          price: "8",
          photo: photo,
        },
        {
          title: { el: "Smoothie Peachy Peachy", en: "Smoothie Peachy Peachy" },
          desc: { el: "Ροδάκινο, Φράουλα, Μπανάνα, Καρότο", en: "Peach, Strawberry, Banana, Carrot" },
          price: "8",
          photo: photo,
        },
        {
          title: { el: "Smoothie Cherry B.", en: "Smoothie Cherry B." },
          desc: { el: "Κεράσι, Μπανάνα, Μήλο, Φραγκοστάφυλλο", en: "Cherry, Banana, Apple, Redcurrant" },
          price: "8",
          photo: photo,
        },
        {
          title: { el: "Smoothie Green Power", en: "Smoothie Green Power" },
          desc: { el: "Αχλάδι, Ανανά, Μπανάνα, Σπανάκι", en: "Pear, Pineapple, Banana, Spinach" },
          price: "8",
          photo: photo,
        },
        {
          title: { el: "Smoothie Very Berry", en: "Smoothie Very Berry" },
          desc: { el: "Φράουλα, Μπανάνα, Φραγκοστάφυλλο, Μύρτιλο, Βατόμουρο", en: "Strawberry, Banana, Redcurrant, Blueberry, Blackberry" },
          price: "8",
          photo: photo,
        },
        {
